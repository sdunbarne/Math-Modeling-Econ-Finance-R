...
## NAME: approximation.R
##
## USAGE: within R, at interactive prompt
##        source("approximation.R")
...
##   is that it creates the approximation as a function on [0,T].  This
##   function can be plotted with any number of points on the interval [0,T].
...
##   information is represented.  If the intention is to plot an
##   scaled random walk approximating Brownian motion, then there are more 
##   direct ways to
##   create and plot the N+1 coordinate pairs defining the graph with an
##   appropriate degree of information.  Here the intention is to first
##   demonstrate the creation of the approximation function, then
##   second to use the function to plot a graph.  This is done for pedagogical
##   reasons to correspond to the mathematical derivation and theorem.
##
...
##
## AUTHOR:  Steve Dunbar
## VERSION: Version 1.0  as of Fri Apr 26, 2013  5:33 AM
